...
public class OneInTheChamberSetupManager {
    public static void finishSetup(Player player, Integer arenaid, Main main) {
        ...
        main.configManager.getArena(arenaid).set("arena.mini_games.one_in_the_chamber.basic.enabled", true);
        main.configManager.saveArena(arenaid);
        main.configManager.getArena(arenaid).set("arena.mini_games.one_in_the_chamber.basic.death_block",
                main.configManager.getSettings().getString("game.global.default_death_block"));
        main.configManager.saveArena(arenaid);
        main.configManager.getArena(arenaid).set("arena.mini_games.one_in_the_chamber.basic.remove_arrows",
                true);
        main.configManager.saveArena(arenaid);
        main.configManager.reloadArena(arenaid);

        StringUtils.sendMessage(player, player.getName(), CacheManager.Language.GLOBAL_SUCCESS_MINI_GAME_SET.replace("{game}", "One In The Chamber"));
    }
}
