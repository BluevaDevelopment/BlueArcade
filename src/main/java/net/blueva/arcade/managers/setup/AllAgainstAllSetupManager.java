...
public class AllAgainstAllSetupManager {
    public static void finishSetup(Player player, Integer arenaid, Main main) {
        ...
        main.configManager.getArena(arenaid).set("arena.mini_games.all_against_all.basic.enabled", true);
        main.configManager.saveArena(arenaid);
        main.configManager.getArena(arenaid).set("arena.mini_games.all_against_all.basic.death_block",
