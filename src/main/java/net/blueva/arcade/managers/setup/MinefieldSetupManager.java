...
public class MinefieldSetupManager {
    ...
    public static void ninthStep(Player player, Integer arenaid, Main main) {
    ...
    public static void finishSetup(Player player, Integer arenaid, Main main) {
        ...
        main.configManager.getArena(arenaid).set("arena.mini_games.minefield.basic.enabled", true);
        main.configManager.saveArena(arenaid);
        main.configManager.getArena(arenaid).set("arena.mini_games.minefield.basic.death_block",
